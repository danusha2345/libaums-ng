...
```ruby
implementation 'com.github.danusha2345.libaums-ng:core:v1.0.2'
```

If you need the HTTP or the storage provider module:

```ruby
implementation 'com.github.danusha2345.libaums-ng:httpserver:v1.0.2'
implementation 'com.github.danusha2345.libaums-ng:storageprovider:v1.0.2'
```
